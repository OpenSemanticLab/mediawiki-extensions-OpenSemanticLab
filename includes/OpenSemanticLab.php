	...
	public static function onPageImporterRegisterPageLists( array &$pageLists ) {
		...
		$pageLists['OpenSemanticLab'] = [
			...
			"pages" => [
				...
				"Template:ELN/Editor/DataSet" => "Template/ELN/Editor/DataSet.mediawiki",
				...
				"Template:ELN/Editor/DataSet/Link" => "Template/ELN/Editor/DataSet/Link.mediawiki",
				...
				"Template:ELN/Editor/DataSet/Subpage" => "Template/ELN/Editor/DataSet/Subpage.mediawiki",
